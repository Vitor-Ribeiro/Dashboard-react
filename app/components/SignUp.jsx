            ...
            <div className="bg-white shadow-md flex mx-auto">
                ...
                <div className="w-1/2 p-10">
                    <div className="mb-10">
                        ...
                        <h1 className="text-3xl font-bold text-[#151F3C]">Sign Up to TailAdmin</h1>
                    </div>

                    <form>
                        <div className="mb-4">
                            <label className="block text-[#151F3C] mb-2" htmlFor="name">Name</label>
                        ...
                        <div className="mb-6">
                            <label className="block text-[#151F3C] mb-2" htmlFor="password">Re-type Password</label>
                            <div className="relative">
                                <input
                                    type="password"
                                    id="password"
                        ...
                        <button className="w-full p-3 bg-blue-600 text-white rounded-lg font-semibold mb-4">Create Account</button>
